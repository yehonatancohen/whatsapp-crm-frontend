...
export function Sidebar({ open, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed right-0 top-0 h-screen [height:100dvh] w-60 bg-cream-dark border-l border-border flex flex-col z-50 transition-transform duration-300 ease-in-out will-change-transform ${
      ...
      >
        ...
        <div className="p-3 border-t border-border">
          ...
          <div className="flex items-center gap-3 px-3 py-2">
            ...
            >
              <div className="w-8 h-8 rounded-full bg-cream-dark flex items-center justify-center text-xs font-medium text-ink shrink-0">
            ...
            <button onClick={handleLogout} className="text-faded hover:text-red-500 transition-colors shrink-0" title="התנתקות">
