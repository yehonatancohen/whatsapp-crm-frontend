    ...
    return (
        <>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
                <div>
                    <h1 className="text-2xl font-semibold text-slate-100">WhatsApp Accounts</h1>
                    <p className="text-sm text-slate-500 mt-1">Manage and connect your numbers</p>
                </div>
                <button
            ...
            {error && (
                <div className="bg-red-500/10 border border-red-500/20 rounded-xl px-4 py-3 mb-6">
                    <p className="text-red-400 text-sm">Backend error: {error}</p>
                </div>
            )}
            ...
            {!loading && accounts.length === 0 && !error && (
                <div className="flex flex-col items-center justify-center py-20 text-center">
                    ...
                    <p className="text-slate-500 text-sm mb-4">Add your first WhatsApp account to get started.</p>
                    <button
                        onClick={() => setModalOpen(true)}
