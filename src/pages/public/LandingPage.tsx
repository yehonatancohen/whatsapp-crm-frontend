...
const features = [
  {
    ...
    desc: 'Connect and manage multiple WhatsApp accounts from a single dashboard.',
    icon: (
  ...
  },
  {
    ...
    desc: 'Send personalized messages to thousands of contacts with smart throttling.',
    icon: (
  ...
  },
  {
    ...
    desc: 'Import, organize, and segment contacts into lists for targeted outreach.',
    icon: (
  ...
  {
    title: 'Number Warmup',
    desc: 'Gradually warm up new numbers to avoid bans and build trust with WhatsApp.',
    icon: (
  ...
  {
    title: 'Unified Inbox',
    desc: 'Read and reply to messages from all accounts in one place.',
    icon: (
  ...
  },
  {
    ...
    desc: 'Track campaign performance, delivery rates, and account activity in real time.',
    icon: (
      ...
      <section className="px-4 pt-16 pb-20 text-center">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl sm:text-5xl font-bold text-charcoal mb-5 leading-tight">
            Manage WhatsApp<br />at scale
          </h1>
          <p className="text-lg text-muted mb-8 max-w-xl mx-auto">
            The all-in-one platform for WhatsApp marketing, multi-account management, and customer engagement.
          </p>
          ...
          <p className="text-xs text-faded mt-4">7-day free trial. No credit card required.</p>
        </div>
      </section>
