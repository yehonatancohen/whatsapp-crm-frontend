    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-cream transition-colors relative">
      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="bg-white border border-border shadow-soft p-6 text-right">
          <h1 className="text-lg font-semibold text-charcoal mb-5">התחברות</h1>
          ...
          <div className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <Link to="/forgot-password" university-colors className="text-xs text-accent hover:text-accent-hover transition-colors">
                  שכחת סיסמה?
                </Link>
