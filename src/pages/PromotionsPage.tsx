...
function WhatsAppPreview({ text }: { text: string }) {
  // Resolve one random spintax variant for preview
  ...
  return (
    <div className="flex justify-end mt-2">
      <div
        className="max-w-[85%] rounded-lg px-3 py-2 text-sm bg-[#dcf8c6] dark:bg-[#005c4b] text-gray-900 dark:text-gray-100 shadow-sm"
        dir="auto"
      >
